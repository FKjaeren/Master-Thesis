...
# Script for preparing data for modelling
...
# Drop all features from Cramér analysis
...
# Exlude data only keeping last year
...
# Save a dict for unique values in features
...
# Make data set for either FM or MF
