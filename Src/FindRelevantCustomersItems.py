...
cust_agg_subset_v2 = cust_agg_subset[(cust_agg_subset['t_dat']>'2020-06-22')]
cust_agg_subset_v2 = cust_agg_subset_v2[cust_agg_subset_v2['customer_id']>4]
cust_agg_subset_v2 = cust_agg_subset_v2.rename(columns = {'customer_id':'purchase_count'}).reset_index()
item_agg_subset2 = item_agg[item_agg['article_id']>=10]
