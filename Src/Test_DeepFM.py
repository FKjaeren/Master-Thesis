...
for c in customers:
    ...
    if(test_df_negatives_temp.shape[0] < 56000):
        ...
        items, true_values = Get_Recommendations(customer_id = c, model = model, test_set=test_df_temp, test_full_set=test_df_negatives_temp, test_full_data_path =None ,chunksize = None,batch_size=batch_size, num_recommendations = num_recommendations)
...
test_df_negatives = test_df_negatives[['customer_id', 'article_id', 'price', 'sales_channel_id', 'day',
    ...
    'club_member_status','fashion_news_frequency', 'age', 'postal_code','target']]
test_df = pd.read_csv('../../../../../../work3/s174478/Data/test_dataset_subset.csv')
test_full_data_path = '../../../../../../work3/s174478/Data/test_dataset_with_negative_part2.csv'
customers = test_df_negatives.customer_id.unique()
for c in customers:
    #batch_size=test_df_negatives_temp.shape[0]
    temp_accuracy = []
